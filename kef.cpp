...
void kef::setStartKeffs(int ktr, float znahimost, int kdog, int krv, int kzp, int kvo, int kot, int kpr, int ktok, int ktsp)
{
...
void kef::setCurrentKeffs(int ktr, float znahimost, int kdog, int krv, int kzp, int kvo, int kot, int kpr, int ktok, int ktsp)
{
...
void kef::_compareAndPaint()
{
    ...
    QList<QLineEdit *> startKeffsLines{ui->ktrStart,
                                       ui->kznStart,
                                       ui->kdogStart,
                                       ui->krvStart,
                                       ui->kzpStart,
                                       ...
                                       ui->ktspStart,
                                       ui->ktokStart};
    QList<QLineEdit *> currentKeffsLines{ui->ktr, ui->kzn, ui->kdog, ui->krv, ui->kzp, ui->kvo, ui->kot, ui->kpr, ui->ktsp, ui->ktok};
    QList<QLabel *>
        labels{ui->lbl_18, ui->lbl_19, ui->lbl_20, ui->lbl_21, ui->lbl_22, ui->lbl_23, ui->lbl_24, ui->lbl_25, ui->lbl_26, ui->lbl_17};
